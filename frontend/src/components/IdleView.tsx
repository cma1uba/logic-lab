...
export function IdleView({
  ...
  return (
    <section className="idle-page flex min-h-screen flex-col justify-center px-5 py-7 sm:py-10">
      <div className="idle-content mx-auto w-full max-w-4xl">
        <header className="workspace-nav mx-auto flex max-w-3xl items-center justify-between">
          ...
          >
            ...
            <span className="settings-provider">{modelOptions.find((option) => option.value === modelType)?.label}</span>
          </button>
        </header>

        <div className="mx-auto max-w-3xl text-center">
          <span className="eyebrow">Your private learning studio</span>
          <h1 className="idle-title mt-5 bg-gradient-to-r from-sky-200 via-blue-400 to-violet-400 bg-clip-text text-transparent">
            Learn anything.
          </h1>
          <p className="idle-subtitle mx-auto mt-5 max-w-2xl text-slate-300">
            Turn a question into a visual explanation you can watch, hear, and understand.
          </p>
        </div>
        ...
        {settingsOpen && (
          <div className="settings-disclosure mx-auto max-w-2xl">
            <div className="provider-panel rounded-2xl px-3 py-3 sm:px-4" aria-label="AI provider settings">
            <div className="mb-3 flex items-center justify-between px-1 text-xs text-slate-400">
              <span className="font-semibold tracking-[0.12em] uppercase text-sky-200">Generation provider</span>
              <span>Your key stays in this browser</span>
            </div>
        ...
        <form className="mt-8" onSubmit={handleSubmit}>
          <div className="prompt-composer relative rounded-2xl p-1 focus-within:border-blue-400/60">
            ...
            <div className="absolute right-4 bottom-4 left-4 flex items-center justify-end gap-3">
              <span className="prompt-hint mr-auto hidden text-sm sm:inline">Visual lesson · narrated for you</span>
